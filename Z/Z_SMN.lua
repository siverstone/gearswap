...
function get_sets()
    ...
    sets.midcast.bp_physical = {
        ammo="サンカスサシェ+1",
        head={ name="ヘリオスバンド", augments={'Pet: Accuracy+28 Pet: Rng. Acc.+28','Pet: "Dbl. Atk."+8','Blood Pact Dmg.+6',}, hp=36, mp=32,},
        body={ name="唱門師浄衣改", augments={'Path: A',}, hp=50, mp=85,},
        ...
        neck={ name="召喚士の首輪+2", augments={'Path: A',}, hp=50, mp=36,},
        waist="インカーネトサッシュ",
        left_ear="ドメスティカピアス",
        right_ear="ルガルバンダピアス",
        left_ring="ヴァラールリング+1",
        right_ring={ name="パルーグリング", hp=40,},
        back={ name="カンペストレケープ", augments={'Pet: Acc.+20 Pet: R.Acc.+20 Pet: Atk.+20 Pet: R.Atk.+20','Pet: Accuracy+10 Pet: Rng. Acc.+10','"Fast Cast"+10','Pet: "Regen"+5',}},
    }
