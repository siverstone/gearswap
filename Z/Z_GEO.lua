...
function get_sets()
    ...
    feet={ name="マーリンクラッコー", augments={'Attack+1','"Fast Cast"+3','MND+8','Mag. Acc.+3','"Mag.Atk.Bns."+14',}},
    neck="オルンミラトルク",
    waist="エンブラサッシュ",
    left_ear="マリグナスピアス",
    right_ear="エテオレートピアス",
...
--        main={ name="ガーダ", augments={'Enh. Mag. eff. dur. +6','VIT+6','"Mag.Atk.Bns."+19','DMG:+13',}},
        sub="アムラピシールド",
    head={ name="テルキネキャップ", augments={'"Cure" potency +8%','Enh. Mag. eff. dur. +10',}},
...
--        main={ name="ガーダ", augments={'Enh. Mag. eff. dur. +6','VIT+6','"Mag.Atk.Bns."+19','DMG:+13',}},
    ...
    feet={ name="ＢＡサンダル+2", augments={'Enhances "Radial Arcana" effect',}},
    neck="ウォーダチャーム+1",
    waist="イーサベルト",
    left_ear="ヒパスピスピアス",
    right_ear="エテオレートピアス",
