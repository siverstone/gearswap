...
function user_setup()
    state.OffenseMode:options('Normal', 'EXP')
--    state.HybridMode:options('Normal')
--    state.WeaponskillMode:options('Normal', 'DmgLim')
    state.Weapons = M{['description']='Use Weapons', 'Kumbhakarna', 'Agwu',}
...
function init_gear_sets()
    sets.weapons = {}
    Kumbhakarna = { main={name="クンバカルナ"}, sub={name="アダパシールド"}}
    Kumbhakarna_dw = { main={name="クンバカルナ"}, sub={name="ターニオンダガー+1"}}
    agwu = { main={name="アグゥアクス"}, sub={name="アダパシールド"}}
    ...
    sets.precast.JA['K.インスティンクト'] = {head={ name="ＡＫヘルム+1", augments={'Enhances "Killer Instinct" effect',}},}
    ...
    left_ring="守りの指輪",
    right_ring="タリアリング",
    back={ name="パストラルマント", augments={'STR+2 DEX+2','Accuracy+1','Pet: Accuracy+12 Pet: Rng. Acc.+12','Pet: Damage taken -5%',}},
    }

    sets.idle = {
    head="マリグナスシャポー",
    body="サクロブレスト",
    hands={ name="ＡＫグローブ+1", augments={'Enhances "Beast Affinity" effect',}},
        legs="グレティブリーチズ",
    feet="マリグナスブーツ",
    neck="アダドアミュレット",
    waist="イーサベルト",
    ...
    left_ring="守りの指輪",
    right_ring="月明の指輪",
    back={ name="メシストピンマント", augments={'Cap. Point+39%','MP+20','DEF+2',}},
    }
