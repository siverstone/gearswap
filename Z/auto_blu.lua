...
local spell_buff_lists = {
    Setup = {
--        {name='エラチックフラッター', buff='ヘイスト', id=710, overwrite=30},
--        {name='オカルテーション', buff='ブリンク', id=679, overwrite=0},
--        {name='N.メディテイト', buff='攻撃力アップ', id=700, overwrite=30},
--        {name='コクーン', buff='防御力アップ',id=547, overwrite=30},
    },
    Engage ={
--        {name='エラチックフラッター', buff='ヘイスト', id=710, overwrite=30},
--        {name='オカルテーション', buff='ブリンク', id=679, overwrite=0},
