...
function user_setup()
    ...
    state.Weapons = M{['description']='Use Weapons', 'Magic', 'Almace', 'Tizona', 'Sequence', 'Club'}
...
function init_gear_sets()
    ...
    sets.weapons.Tizona = {main={name="クトゥルブナイフ"}, sub={name="アルマス"},}
    sets.weapons.Sequence = {main={name="セクエンス"}, sub={name="アルマス"},}
    sets.weapons.Magic = {main={name="サクパタソード"}, sub={name="ブンジロッド"},}
    sets.weapons.Club = {main={name=""}, sub={name=""},}
