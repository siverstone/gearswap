...
function get_sets()
    ...
    sets.precast.fc = {
    head={ name="マーリンフード", augments={'Mag. Acc.+11','"Fast Cast"+3','MND+2','"Mag.Atk.Bns."+1',}},
    ...
    body={ name="アマリクダブレット", augments={'MP+60','Mag. Acc.+15','"Mag.Atk.Bns."+15',}, mp=133},
    ...
    sets.midcast.death_mb = {
        ammo="ペムフレドタスラム",
        head={ name="妖蟲の髪飾り+1", mp=120},
    body={ name="エアウプランド", mp=94},
    hands={ name="エアカフス", mp=14},
    legs={ name="ＳＰトンバン+2", mp=148},
        feet={ name="ＡＭネール+1", augments={'MP+80','Mag. Acc.+20','"Mag.Atk.Bns."+20',}, mp=106},
        neck="水影の首飾り",
        waist="闇輪の帯",
        left_ear={ name="王将の耳飾り", mp=20},
...
--    body="ジャリローブ+2",
    ...
    sets.midcast.mb_high = {
        ...
        body={ name="エアウプランド+1", mp=109},
        hands={ name="ＡＭゲージ+1", augments={'INT+12','Mag. Acc.+20','"Mag.Atk.Bns."+20',}, mp=26},
        legs={ name="ＡＭスロップス+1", augments={'MP+80','Mag. Acc.+20','"Mag.Atk.Bns."+20',}, mp=185},
        feet={ name="ＡＭネール+1", augments={'MP+80','Mag. Acc.+20','"Mag.Atk.Bns."+20',}, mp=106},
        neck="水影の首飾り",
        waist={ name="山吹の帯", mp=35},
    ...
    sets.midcast.mb_mid = {
    ammo={ name="ガストリタスラム+1", augments={'Path: A',}},
        head={ name="エアハット", mp=50},
        body={ name="ＳＰコート+3", mp=98},
        hands={ name="ＡＭゲージ+1", augments={'INT+12','Mag. Acc.+20','"Mag.Atk.Bns."+20',}, mp=26},
        legs={ name="ＡＭスロップス+1", augments={'MP+80','Mag. Acc.+20','"Mag.Atk.Bns."+20',}, mp=185},
        feet={ name="アグゥピガッシュ", mp=44},
        neck="水影の首飾り",
        waist="サクロコード",
        left_ear={ name="王将の耳飾り", mp=20},
        right_ear="マリグナスピアス",
    ...
    feet={ name="ＡＲサボ+1", augments={'Increases Aspir absorption amount',}},
    neck="サンクトネックレス",
    waist="風鳥の帯",
        left_ear={ name="王将の耳飾り", mp=20},
        right_ear="マリグナスピアス",
...
function self_command(command)
    ...
    elseif command == 'aspir' then
        ...
        if recast_time_a3 == 0 then
            send_command('input /magic '..windower.to_shift_jis('アスピルIII')..' <t>')
