...
local enmity_lists = {
    {name='かまえる', id=17, pf='/ja', t='me'},
    {name='気孔弾', id=18, pf='/ja', t='t'},
}
...
--    {name='挑発', id=5, pf='/ja', t='t', job='戦'},  
    ...
    {name='心眼', id=133, pf='/ja', t='me', job='侍'},
    {name='黙想', id=134, pf='/ja', t='me', job='侍'},
    {name='石火之機', id=140, pf='/ja', t='me', job='侍'},
--    {name='暗闇の術:弐', id=348, pf='/ma', t='t', job='忍'},
--    {name='捕縄の術:弐', id=345, pf='/ma', t='t', job='忍'},
    {name='スタン', id=252, pf='/ma', t='t', job='暗'},
    {name='アルケインサークル', id=86, pf='/ja', t='me', job='暗'},
    {name='ラストリゾート', id=87, pf='/ja', t='me', job='暗'},
...
local ability_buff_lists = {
    {name='絶対カウンター', id=22, pf='/ja', t='me'},
    {name='集中', id=13, pf='/ja', t='me'},
    {name='回避', id=14, pf='/ja', t='me'},
    {name='猫足立ち', id=21, pf='/ja', t='me'},
    {name='インピタス', id=31, pf='/ja', t='me'},
}
...
local use_ws = 'ビクトリースマイト'
local use_ws_kick = 'ビクトリースマイト'
--local use_ws_kick = '闘魂旋風脚'
function check_ws()
    if not check_can_use_ability() then return false end
    if buffactive['猫足立ち'] then
        if player.tp >= 1000 then
            windower.chat.input('/ws "'..windower.to_shift_jis(use_ws_kick) ..'" <t>')
            tickdelay = os.clock() + 5
            return true
        end
    else
