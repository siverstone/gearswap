...
function user_setup()
    ...
    state.PetMode = M{['description']='Pet Mode', 'None', 'Melee', 'Tank', 'Ranged', 'Magic', 'Heal', 'Nuke',}
    state.PetSubMode = M{['desctiption']='Pet Sub Mode'}
    state.PetTankMode = M{['desctiption']='Pet Sub Mode', 'Enmity', 'HPDT', 'HP', 'DT'}
    state.PetMeleeMode = M{['desctiption']='Pet Sub Mode', 'Stp', 'Multi'}
    state.ManeuverMode = M{['description']='Maneuver Mode', 'Mid', 'Low', 'High', 'Status'}
    state.Weapons = M{['description']='Use Weapons', 'Kenkonken', 'Sakpata', 'Gnafron', 'Verethragna', 'Karambit',}
    ...
    bool_state = {
        ...
        {label='AutoManu', mode='AutoManuevers', alys_disp=false}
    }
    mode_state = {
...
function init_gear_sets()
    ...
    sets.weapons.Sakpata = {main="サクパタフィスト", ammo="ルブリカント+3",}
...
-- state.PetMode = M{['description']='Pet Mode', 'None', 'Tank', 'Melee', 'Ranged', 'Magic', 'Heal', 'Nuke',}
    ...
    head={ name="テーオンシャポー", augments={'Pet: Accuracy+24 Pet: Rng. Acc.+24','Pet: "Dbl. Atk."+5','Phalanx +2',}},
    body={ name="テーオンタバード", augments={'Pet: Accuracy+24 Pet: Rng. Acc.+24','Pet: "Dbl. Atk."+5',}},
    hands={ name="テーオングローブ", augments={'Pet: Accuracy+25 Pet: Rng. Acc.+25','Pet: "Dbl. Atk."+5','Pet: Haste+5',}},
    legs={ name="テーオンタイツ", augments={'Pet: Accuracy+25 Pet: Rng. Acc.+25','Pet: "Dbl. Atk."+5',}},
    feet={ name="テーオンブーツ", augments={'Pet: Accuracy+25 Pet: Rng. Acc.+25','Pet: "Dbl. Atk."+5',}},
    neck="シュルマヌカラー",
    waist="インカーネトサッシュ",
    left_ear="エンメルカルピアス",
    right_ear={ name="カラゴズピアス+1", augments={'System: 1 ID: 1676 Val: 0','Accuracy+14','Mag. Acc.+14','"Store TP"+5',}},
