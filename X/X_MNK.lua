...
function user_setup()
    ...
    state.Weapons = M{['description']='Use Weapons', 'Verethragna', 'Xoanon', 'Sagitta',}
...
function init_gear_sets()
    sets.weapons = {}
    sets.weapons.Sagitta = {main="スファライ",}
    sets.weapons.Verethragna = {main="ウルスラグナ",}
--    sets.weapons.Karambit = {main="カランビット",}
    sets.weapons.Xoanon = {main="ゾアノン", sub="アンブラストラップ"}
...
--      head="白ララブキャップ+1",
    ...
    ammo="昏黄の礫",
        ...
        body="ＡＮシクラス+3",
    hands={ name="龍王手甲", augments={'STR+10','DEX+10','Accuracy+15',}},
    ...
    neck="ジャステシアトルク",
        ...
        left_ring="ゲリリング",
        right_ring="ニックマドゥリング",
    back={ name="セゴモマント", augments={'STR+20','Accuracy+20 Attack+20','STR+10','Crit.hit rate+10',}},
    }
    ...
    sets.precast.WS["バックハンドブロー"]['インピタス'] = set_combine(sets.precast.WS.critical, {body="ＢＫシクラス+3",})
    sets.precast.WS["アスケーテンツォルン"]['インピタス'] = set_combine(sets.precast.WS.critical, {body="ＢＫシクラス+3",})
    sets.precast.WS["ビクトリースマイト"]['インピタス'] = set_combine(sets.precast.WS.critical, {body="ＢＫシクラス+3",})
    ...
    sets.precast.WS["バックハンドブロー"]['インピタスDmgLim'] = set_combine(sets.precast.WS.critical, sets.precast.WS.dmglim, {body="ＢＫシクラス+3",})
    sets.precast.WS["アスケーテンツォルン"]['インピタスDmgLim'] = set_combine(sets.precast.WS.critical, sets.precast.WS.dmglim, {body="ＢＫシクラス+3",})
    sets.precast.WS["ビクトリースマイト"]['インピタスDmgLim'] = set_combine(sets.precast.WS.critical, sets.precast.WS.dmglim, {body="ＢＫシクラス+3",})
