...
function user_setup()
    ...
    state.Lullaby =  M{['description']='Use Instruments', 'String', 'Wind'}
...
function init_gear_sets()
    sets.Linos_melee = {range={ name="リノス", augments={'Accuracy+19','"Dbl.Atk."+3','Quadruple Attack +3',}},}
    sets.Linos_ws = {range={ name="リノス", augments={'Accuracy+15 Attack+15','Weapon skill damage +3%','STR+6 DEX+6',}},}
    sets.Lullaby = {Wind = {range="ギャッラルホルン",}, String = {range="ブラーハープ+1",}}
    sets.weapons = {}

    sets.weapons.Levante = set_combine({main={name="レヴァンテダガー"}, sub={name="カルミナス"}}, sets.Linos_melee)
    ...
    sets.weapons.Tauret = set_combine({main={name="トーレット"}, sub={name="アムラピシールド"},}, sets.Linos_melee)
...
--        main={ name="カーリ", augments={'MP+60','Mag. Acc.+20','"Refresh"+1',}},
    ...
    sets.precast.JA["ソウルボイス"] = {legs={ name="ＢＩキャニオンズ+2", augments={'Enhances "Soul Voice" effect',}},}
    sets.precast.JA["ナイチンゲール"] = {feet={ name="ＢＩスリッパー+2", augments={'Enhances "Nightingale" effect',}},}
    sets.precast.JA["トルバドゥール"] = {body={ name="ＢＩジュストコル+2", augments={'Enhances "Troubadour" effect',}},}
...
--        main={ name="カーリ", augments={'MP+60','Mag. Acc.+20','"Refresh"+1',}},
    ...
    sets.engaged = {
--    range={ name="リノス", augments={'Accuracy+19','"Dbl.Atk."+3','Quadruple Attack +3',}},
