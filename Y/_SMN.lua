...
function get_sets()
    ...
    sets.smn_skill = {
        ...
        body={ name="ＢＣダブレット+2", hp=54, mp=151,},
        hands={ name="ラマスミトン+1", hp=18, mp=44,},
        legs={ name="ＢＣスパッツ+2", hp=41, mp=116,},
        ...
        right_ring={ name="エタナリング", hp=60, mp=60,},
        back={ name="コンベイケープ", mp=100,},
    }

    sets.precast.fc = {
        ammo="サンカスサシェ+1",
        head={ name="マーリンフード", augments={'"Mag.Atk.Bns."+25','"Fast Cast"+6',}, hp=22, mp=56},
        body={ name="インヤガジュバ+2", hp=85, mp=90,},
        ...
        feet={ name="マーリンクラッコー", augments={'"Fast Cast"+4',}, hp=4, mp=20,},
        neck={ name="オルンミラトルク", mp=30,},
        waist="エンブラサッシュ",
        left_ear="マリグナスピアス",
        right_ear={ name="ロケイシャスピアス", mp=30,},
        left_ring="キシャールリング",
        right_ring={ name="エタナリング", hp=60, mp=60,},
        back={ name="カンペストレケープ", augments={'"Fast Cast"+10',}},
    }
    ...
    head="ＢＣホーン+2",
    body="ＣＮダブレット+3",
    hands={ name="ラマスミトン+1", augments={'Path: A',}},
    legs="ＢＣスパッツ+2",
    ...
    sets.midcast.bp_physical = {
        ...
        feet={ name="ＣＮピガッシュ+3", hp=23, mp=71,},
        neck={ name="召喚士の首輪+1", augments={'Path: A',}, hp=40,},
        waist="インカーネトサッシュ",
        left_ear="ルガルバンダピアス",
        right_ear={ name="ベコナーピアス+1", augments={'System: 1 ID: 1676 Val: 0','Pet: Accuracy+11 Pet: Rng. Acc.+11','Pet: Mag. Acc.+11','Damage taken-3%',}},
        left_ring="ヴァラールリング+1",
        right_ring={ name="パルーグリング", hp=40,},
        back={ name="カンペストレケープ", augments={'Pet: Acc.+20 Pet: R.Acc.+20 Pet: Atk.+20 Pet: R.Atk.+20','Pet: Accuracy+10 Pet: Rng. Acc.+10','Pet: "Regen"+10','Pet: "Regen"+5',}},
    }
    ...
    sets.midcast.cure = {
        ...
        neck={ name="召喚士の首輪+1", augments={'Path: A',}, hp=40,mp=28,},
        waist={ name="神術帯+1", mp=85},
        left_ear={ name="メンデカントピアス", mp=30},
        right_ear={ name="ロケイシャスピアス", mp=30,},
        left_ring={ name="レベッチェリング", mp=40},
        right_ring="スティキニリング",
        back={ name="コンベイケープ", mp=100,},
    }

    sets.midcast.enhance_duration = {
        head={ name="テルキネキャップ", augments={'Enh. Mag. eff. dur. +10',}, hp=36, mp=32},
        body={ name="テルキネシャジュブ", augments={'"Fast Cast"+5','Enh. Mag. eff. dur. +10',}, hp=54, mp=59},
        hands={ name="テルキネグローブ", augments={'Potency of "Cure" effect received+7%','Enh. Mag. eff. dur. +10',}, hp=52, mp=44},
        legs={ name="テルキネブラコーニ", augments={'"Cure" potency +7%','Enh. Mag. eff. dur. +10',}, hp=43, mp=29},
        feet={ name="テルキネピガッシュ", augments={'"Fast Cast"+5','Enh. Mag. eff. dur. +10',}, hp=13, mp=44},
        waist="エンブラサッシュ",
    ...
    sets.aftercast.idle_favor = {
        ...
        legs={ name="アシドゥイズボン+1", augments={'Path: A',}, hp=43, mp=49,},
        feet={ name="ＣＮピガッシュ+3", hp=23, mp=71,},
        neck={ name="召喚士の首輪+1", augments={'Path: A',}, hp=40,mp=28,},
        waist="ルセデティサッシュ",
        left_ear={ name="エヴァンズピアス", mp=50,},
